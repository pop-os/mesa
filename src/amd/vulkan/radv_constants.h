...
/* Shader GDS counters:
 *   offset 0            - number of primitives generated by geometry shader invocations
 *   offset 4            - number of geometry shader invocations
 *   offset 8 |12|16|20  - generated primitive counter for stream 0|1|2|3
 *   offset 24|28|32|36  - written primitive counter for stream 0|1|2|3
 *
 * Mesh shader GDS counters:
 *   offset 40 - number of mesh shader invocations
 *   offset 44 - number of mesh shader generated primitives
 *
 * Task shader GDS counter:
 *   offset 48 - number of task shader invocations
 */
#define RADV_SHADER_QUERY_GS_PRIM_EMIT_OFFSET     0
#define RADV_SHADER_QUERY_GS_INVOCATION_OFFSET    4
#define RADV_SHADER_QUERY_PRIM_GEN_OFFSET(stream) (8 + stream * 4)
#define RADV_SHADER_QUERY_PRIM_XFB_OFFSET(stream) (24 + stream * 4)
#define RADV_SHADER_QUERY_MS_INVOCATION_OFFSET    40
