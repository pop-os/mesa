...
CHIPSET(0x46a6, adl_gt2, "ADL GT2", "Intel(R) Iris(R) Xe Graphics")
...
CHIPSET(0xd740, nvl_s_hx_ul, "NVL-S", "Intel(R) Graphics")
CHIPSET(0xd741, nvl_u_h, "NVL-U", "Intel(R) Graphics")
CHIPSET(0xd742, nvl_u_h, "NVL-H", "Intel(R) Graphics")
CHIPSET(0xd743, nvl_s_hx_ul, "NVL-HX", "Intel(R) Graphics")
CHIPSET(0xd745, nvl_s_hx_ul, "NVL-HX", "Intel(R) Graphics")

CHIPSET(0xd750, nvl_p, "NVL-P", "Intel(R) Graphics", FORCE_PROBE)
CHIPSET(0xd751, nvl_p, "NVL-P", "Intel(R) Graphics", FORCE_PROBE)
CHIPSET(0xd752, nvl_p, "NVL-P", "Intel(R) Graphics", FORCE_PROBE)
CHIPSET(0xd753, nvl_p, "NVL-P", "Intel(R) Graphics", FORCE_PROBE)
CHIPSET(0xd754, nvl_p, "NVL-P", "Intel(R) Graphics", FORCE_PROBE)
CHIPSET(0xd755, nvl_p, "NVL-P", "Intel(R) Graphics", FORCE_PROBE)
CHIPSET(0xd756, nvl_p, "NVL-P", "Intel(R) Graphics", FORCE_PROBE)
CHIPSET(0xd757, nvl_p, "NVL-P", "Intel(R) Graphics", FORCE_PROBE)
CHIPSET(0xd75f, nvl_p, "NVL-P", "Intel(R) Graphics", FORCE_PROBE)
